...
('Nước uống', 'Các loại nước uống, nước ngọt, nước suối'),
('Thực phẩm', 'Bánh mì, đồ ăn nhanh, thực phẩm tươi sống'),
('Bánh kẹo', 'Bánh ngọt, kẹo, snack'),
('Đồ uống', 'Cà phê, trà, nước ép'),
('Snack', 'Bánh snack, khoai tây chiên'),
('Thuốc lá', 'Thuốc lá các loại'),
('Vật dụng', 'Vật dụng hàng ngày, dụng cụ');
